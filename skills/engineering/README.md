...
- **[codebase-atlas](./codebase-atlas/SKILL.md)**: Build and maintain a persistent codebase atlas under `docs/atlas/`: symbol cards, named execution flows, impact rings with risk levels, per-region freshness. Targeted completion maps only the region you are about to change.
