...
description: 变更完成后归档：Finalize a completed OpenSpec change — check it's actually done, then delegate the merge-and-file to `openspec archive`. The step that turns a finished change into a permanent part of the spec's source of truth.
