...
- **[codebase-atlas](./skills/engineering/codebase-atlas/SKILL.md)**: Build and maintain a persistent codebase atlas as plain Markdown committed to the repo: symbol cards, named execution flows, impact rings with risk levels, and per-region freshness, completed targetedly around whatever you are about to change.
