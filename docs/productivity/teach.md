...
```bash
npx skills add yangpf5271/mattpocock-skills-openspec --skill=teach
```
...
[Source](https://github.com/yangpf5271/mattpocock-skills-openspec/tree/main/skills/productivity/teach)
