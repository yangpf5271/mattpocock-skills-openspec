...
```bash
npx skills add yangpf5271/mattpocock-skills-openspec --skill=domain-modeling
```
...
[Source](https://github.com/yangpf5271/mattpocock-skills-openspec/tree/main/skills/engineering/domain-modeling)
